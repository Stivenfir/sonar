...
function DetectarNombreEstado($estadoSearch)
{
    ...
    $DataArray = array(
        ...
        'ConLevanteSinDespachoSinPasarFact'  => 'Con Levante Sin Despacho - Sin Pasar a Facturar',
        'ConLevanteSinDespachoSinGenerarFact' => 'Con Levante Sin Despacho - Sin generar factura',
        'ConLevanteSinDespachoFacturado'     => 'Con Levante Sin Despacho - Facturado',
        ...
        'PrefacturaGenerada'                 => 'Prefactura Generada',
        'FacturaEnviadaCliente'              => 'Factura enviada a cliente',
        'FacturaAprobadaCliente'             => 'Factura aprobada por cliente',
...
function ReturnNameGrupo($estadoSearch)
{
    $FulllData = array(
        ...
        'ConLevanteSinDespachoSinPasarFact' => 'Proceso de Despacho y Pasar a Facturar',
        'ConLevanteSinDespachoSinGenerarFact' => 'Proceso de Despacho y Pasar a Facturar',
        'ConLevanteSinDespachoFacturado'  => 'En proceso de Facturación',
        ...
        'PrefacturaGenerada'              => 'En proceso de Facturación',
        'FacturaEnviadaCliente'           => 'En proceso de Facturación',
        'FacturaAprobadaCliente'          => 'En proceso de Facturación',
